...
QT_MOC_LITERAL(1, 18, 8), // "onImport"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 8), // "onExport"
QT_MOC_LITERAL(4, 37, 13), // "onExportImage"
QT_MOC_LITERAL(5, 51, 18) // "onSelectionChanged"

    },
    "ApplicationWindow\0onImport\0\0onExport\0"
    "onExportImage\0onSelectionChanged"
};
...
const QMetaObject ApplicationWindow::staticMetaObject = {
    { &ApplicationCommonWindow::staticMetaObject, qt_meta_stringdata_ApplicationWindow.data,
...
void *ApplicationWindow::qt_metacast(const char *_clname)
{
    ...
    return ApplicationCommonWindow::qt_metacast(_clname);
}

int ApplicationWindow::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = ApplicationCommonWindow::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 4)
