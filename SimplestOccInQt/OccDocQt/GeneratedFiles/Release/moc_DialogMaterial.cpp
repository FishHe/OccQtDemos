...
QT_MOC_LITERAL(1, 15, 19), // "sendMaterialChanged"
QT_MOC_LITERAL(2, 35, 0), // ""
QT_MOC_LITERAL(3, 36, 13), // "updateButtons"
QT_MOC_LITERAL(4, 50, 4) // "isOn"

    },
    "DialogMaterial\0sendMaterialChanged\0\0"
    "updateButtons\0isOn"
};
...
void DialogMaterial::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        DialogMaterial *_t = static_cast<DialogMaterial *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendMaterialChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->updateButtons((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (DialogMaterial::*_t)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DialogMaterial::sendMaterialChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject DialogMaterial::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_DialogMaterial.data,
      qt_meta_data_DialogMaterial,  qt_static_metacall, nullptr, nullptr}
};
